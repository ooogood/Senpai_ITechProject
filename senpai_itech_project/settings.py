...
ROOT_URLCONF = 'senpai_itech_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # add media to allow file.url can be used w/o {{MEDIA_URL}} in the front
...
WSGI_APPLICATION = 'senpai_itech_project.wsgi.application'
